...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-md">
        ...
        <!-- Stripe -->
        <a href="{{ route('stripe.checkout.warranty.extended', compact('warrantyId', 'planId')) }}"
        ...
        {{-- <a href="{{ route('paytabs.checkout', ['type' => "import", 'id' => $import->id]) }}"
            class="flex items-center justify-between bg-green-600 hover:bg-green-700 text-white rounded-xl p-5 mt-4">

            <div>
                <h3 class="font-bold">PayTabs</h3>
