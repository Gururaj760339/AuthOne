                ...
                <form action="{{ route('user.register') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block font-medium text-gray-700">{{ translate('First Name') }}</label>
                                <input type="text" name="first_name"
                                    class="w-full border rounded-lg px-4 py-3 mt-1 focus:ring-2 focus:ring-red-500 outline-none"
                                    required>
                            </div>
                            <div>
                                <label class="block font-medium text-gray-700">{{ translate('Last Name') }}</label>
                        ...
                        <!-- Other Fields -->
                        <div>
                            <label class="block font-medium text-gray-700">{{ translate('Email Address') }}</label>
                            <input type="email" name="email"
                                class="w-full border rounded-lg px-4 py-3 mt-1 focus:ring-2 focus:ring-red-500 outline-none"
                                required>
                        </div>
                        <div>
                            <label class="block font-medium text-gray-700">{{ translate('Phone Number') }}</label>
                            <input type="tel" name="phone"
                                class="w-full border rounded-lg px-4 py-3 mt-1 focus:ring-2 focus:ring-red-500 outline-none"
                                required>
                        </div>
                        <div>
                            <label class="block font-medium text-gray-700">{{ translate('Profile Picture') }}</label>
                            <input type="file" name="profile_picture"
                                class="w-full border rounded-lg px-4 py-2 mt-1 focus:ring-2 focus:ring-red-500 outline-none"
                                accept="image/*">
                        </div>
                        <div>
                            <label class="block font-medium text-gray-700">{{ translate('Password') }}</label>
                        ...
                        <div id="vendorFields" class="hidden space-y-5 mt-5">
                            ...
                            <div>
                                <label class="block font-medium text-gray-700">{{ translate('Vendor Type') }}</label>
                                <select name="vendor_type" class="w-full border rounded-lg px-4 py-3 mt-1">
                                    <option value="">Select Vendor Type</option>
                                    <option value="service">{{ translate('Service (Workshop & Car Wash)') }}</option>
                                    <option value="dealer">{{ translate('Car Dealer') }}</option>
                                    <option value="rental">{{ translate('Car Rental') }}</option>
                                    <option value="car_importer">{{ translate('Car Importer') }}</option>
                                </select>
                            </div>

                            <div>
                                <label class="block font-medium text-gray-700">{{ translate('Business Name') }}</label>
                                <input type="text" name="business_name"
                                    class="w-full border rounded-lg px-4 py-3 mt-1">
                            </div>

                            <div>
                                <label class="block font-medium text-gray-700">{{ translate('Trade License') }}</label>
                                <input type="text" name="trade_license"
                                    class="w-full border rounded-lg px-4 py-3 mt-1">
                            </div>

                            <div>
                                <label class="block font-medium text-gray-700">{{ translate('Business Address') }}</label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block font-medium text-gray-700">{{ translate('City') }}</label>
                                    <input type="text" name="city"
                                        class="w-full border rounded-lg px-4 py-3 mt-1">
                                </div>

                                <div>
                                    <label class="block font-medium text-gray-700">{{ translate('Country') }}</label>
                            ...
                            <div>
                                <label class="block font-medium text-gray-700">{{ translate('Business Logo') }}</label>
